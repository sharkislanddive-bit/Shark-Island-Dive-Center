...
const MOCK_EVENTS: DailyEvent[] = [
  // Initial data will be auto-generated by ensureDailySlots
];
...
// Auto-generates the standard 3 slots if missing
export const ensureDailySlots = (dateStr: string): DailyEvent[] => {
    let events = getEvents();
    let dayEvents = events.filter(e => e.date === dateStr);

    if (dayEvents.length === 0) {
        // Generate the 3 Standard Slots
        const newEvents: DailyEvent[] = [
            {
                id: `evt-${dateStr}-1`,
                date: dateStr,
                time: '08:30',
                title: 'Tiger Harbour (Guaranteed)',
                type: 'Tiger Harbour',
                boat: 'Shark One',
                staffIds: [],
                guestCount: 0,
            ...
            },
            {
                ...
                date: dateStr,
                time: '10:30',
                title: 'Reef Dive 1 (TBD)',
                type: 'Reef Dive',
                boat: 'Shark One',
                staffIds: [],
                guestCount: 0,
                notes: 'Update dive site'
            },
            {
                id: `evt-${dateStr}-3`,
                date: dateStr,
                time: '14:30',
                title: 'Reef Dive 2 (TBD)',
                type: 'Reef Dive',
                boat: 'Shark One',
                staffIds: [],
                guestCount: 0,
...
export const getEventsForDate = (dateStr: string): DailyEvent[] => {
  return ensureDailySlots(dateStr);
};
