    ...
    <div className="w-64 bg-shark-950 text-white flex flex-col h-screen fixed left-0 top-0 z-50 shadow-2xl">
      ...
      <div className="p-4 border-t border-shark-800">
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-shark-900">
            <img src="https://ui-avatars.com/api/?name=Admin+User&background=random" className="w-8 h-8 rounded-full" />
            <div className="flex-1 overflow-hidden">
                <div className="text-sm font-bold truncate">Lonu (Admin)</div>
                <div className="text-xs text-teal-400">Online</div>
            </div>
            <LogOut size={16} className="text-shark-500 hover:text-white cursor-pointer" />
        </div>
      </div>
    </div>
  );
